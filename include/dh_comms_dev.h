...
namespace dh_comms
{
    ...
    __device__ inline void generic_submit_message(dh_comms_resources *rsrc, // Pointer to dh_comms device resources used for message submission.
    ...
    __device__ inline void s_submit_message(dh_comms_resources *rsrc,         //!< Pointer to dh_comms device resources used for message submission.
                                                                              //!< This pointer is acquired by host code by calling dh_comms::get_dev_rsrc_ptr(),
                                                                              //!< and passed as a kernel argument to kernels that want to use v_submit_message().
    ...
    //!
    //! Messages are submitted on a per-wave basis, and only the first active lane in the wave submits.
    __device__ inline void s_submit_timestamp(dh_comms_resources *rsrc) //!< Pointer to dh_comms device resources used for message submission.
    {
